<%-- 
    ...
    Created on : Feb 17, 2016, 10:25:00 AM
        ...
        <div class="container">
            ...
            <h1>LVA <span>Movies</span></h1>
                ...
                <section id="LoginRegisterBox">
                    ...
                    <h2 id="h2Form">Forgotten your password?</h2>
                    ...
                    <form name="forgotPass" id="formValidation" method="post" action="UserActionServlet" class="minimal">
                        ...
                        <button type="submit" value="forgotPass" class="btn-minimal">Send Verification Link</button>
                    </form>
                </section>
